      ...
      <div className="space-y-16 relative">
        ...
        <header className="flex flex-col md:flex-row items-start md:items-end justify-between gap-10 border-b border-coffee-50 pb-16">
          <div className="space-y-4">
            ...
            <h1 className="text-7xl font-display font-black text-coffee-950 tracking-tightest leading-none italic uppercase">Wholesale <br/><span className="not-italic text-coffee-400">Partners.</span></h1>
            <p className="text-xl text-coffee-400 font-serif italic">Global management of <span className="text-coffee-950 font-black not-italic uppercase">high-volume extraction</span> partnerships.</p>
          </div>

          <div className="flex flex-wrap items-center gap-6">
            <div className="px-8 py-5 bg-white shadow-premium rounded-[2rem] flex items-center gap-8 border border-coffee-50 group hover:border-emerald-100 transition-all duration-700">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] font-black text-coffee-300 uppercase tracking-[0.4em] italic mb-1 leading-none">ACTIVE_NODES</span>
                <span className="text-3xl font-display font-black text-coffee-950 italic leading-none">{accounts.filter(a => a.status === 'approved').length}</span>
              </div>
            </div>
            <div className="px-8 py-5 bg-white shadow-premium rounded-[2rem] flex items-center gap-8 border border-coffee-50 group hover:border-amber-100 transition-all duration-700">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] font-black text-coffee-300 uppercase tracking-[0.4em] italic mb-1 leading-none">PENDING_NODES</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {loading ? (
            ...
            <motion.div 
              ...
              className="bg-white p-12 rounded-[4rem] border border-coffee-50 shadow-premium-lg hover:shadow-premium-xl transition-all duration-1000 group hover:-translate-y-4 relative overflow-hidden"
            >
              ...
              <div className="flex justify-between items-start mb-10 relative z-10">
                <div className="w-16 h-16 bg-coffee-50 text-gold-500 rounded-2xl flex items-center justify-center shadow-premium border border-coffee-100 group-hover:rotate-12 transition-transform duration-700">
              ...
              <div className="mb-10 relative z-10 space-y-4">
                <h3 className="text-4xl font-display font-black text-coffee-950 italic uppercase tracking-tightest leading-none line-clamp-2">{account.businessName}</h3>
                <p className="text-[11px] text-coffee-300 font-black uppercase tracking-[0.4em] italic">{account.businessType}_SECTOR</p>
              </div>

              <div className="pt-10 mb-10 border-t border-coffee-50 space-y-6 relative z-10">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-black text-coffee-200 uppercase tracking-[0.4em] italic leading-none">TAX_IDENTITY</span>
                  <span className="font-mono text-[11px] font-black text-coffee-950 uppercase tracking-widest bg-coffee-50 px-3 py-1 rounded-lg">{account.taxId}</span>
                </div>
              </div>
              ...
              <div className="flex gap-4 relative z-10">
                ...
                {account.status === 'approved' && (
                  <button className="w-full py-5 bg-coffee-950 text-gold-500 rounded-[1.5rem] text-[11px] font-black uppercase tracking-[0.4em] flex items-center justify-center gap-4 italic shadow-premium">
        ...
        {!loading && filteredAccounts.length === 0 && (
          <div className="py-40 text-center bg-white rounded-[5rem] border border-coffee-50 shadow-premium relative overflow-hidden group">
            <div className="mesh-gradient absolute inset-0 opacity-[0.02]" />
            <div className="relative z-10 space-y-8">
               <div className="w-24 h-24 bg-coffee-50 text-coffee-200 rounded-[3rem] flex items-center justify-center mx-auto shadow-inner group-hover:scale-110 transition-transform duration-1000">
                  <Search size={40} strokeWidth={1} />
               </div>
               <p className="text-xl text-coffee-300 font-serif italic">No wholesale nodes found in current coordinate mapping.</p>
            </div>
          </div>
        )}
      </div>
