      ...
      <div className="space-y-16 relative">
        <header className="flex flex-col md:flex-row items-start md:items-end justify-between gap-10 border-b border-coffee-50 pb-16">
          <div className="space-y-4">
            ...
            <h1 className="text-7xl font-display font-black text-coffee-950 tracking-tightest leading-none italic uppercase">Operations <br/><span className="not-italic text-coffee-400">Center.</span></h1>
            <p className="text-xl text-coffee-400 font-serif italic">Strategic monitoring of the <span className="text-coffee-950 font-black not-italic uppercase">CoffeeCraze</span> sensory ecosystem.</p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6">
            ...
            <div className="px-8 py-5 bg-coffee-950 shadow-premium-lg rounded-[2rem] flex items-center gap-6 border border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="bg-white p-12 rounded-[4rem] border border-coffee-50 shadow-premium hover:shadow-premium-xl relative overflow-hidden group hover:-translate-y-2 transition-all duration-1000"
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-10">
                  <div className={cn("w-14 h-14 rounded-2xl flex items-center justify-center text-white shadow-xl transition-transform duration-700 group-hover:rotate-12", stat.color)}>
                    {stat.icon}
                  </div>
                ...
                <p className="text-4xl font-display font-black text-coffee-950 tracking-tightest italic leading-none uppercase">{stat.value}</p>
              </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-12">
          ...
          <div className="xl:col-span-1 bg-white p-12 md:p-16 rounded-[5rem] border border-coffee-50 shadow-premium-lg relative overflow-hidden group h-fit">
            <div className="flex items-center justify-between mb-16 relative z-10">
              <div className="space-y-4">
                <span className="stat-label text-gold-500">Logistics_Queue</span>
                <h2 className="text-4xl font-display font-black text-coffee-950 italic uppercase tracking-tightest leading-none">Next <br/><span className="not-italic text-coffee-400">Extractions.</span></h2>
              </div>
              <div className="w-14 h-14 bg-coffee-50 rounded-2xl flex items-center justify-center text-gold-500 shadow-premium border border-coffee-100">
            ...
            <div className="space-y-10 relative z-10">
              ...
              {[1, 2, 3].map((_, i) => (
                <div key={i} className="p-8 bg-cream/50 rounded-[3rem] border border-white hover:border-gold-500/30 transition-all duration-700 group/item">
              ...
              <Link to="/admin/subscriptions" className="btn-premium w-full py-6 italic text-xs uppercase ring-1 ring-coffee-50 group/more">
                View Full Queue <ChevronRight size={18} className="ml-4 group-hover/more:translate-x-4 transition-transform duration-700" />
              </Link>
            </div>
          </div>

          <div className="xl:col-span-2 bg-white p-12 md:p-16 rounded-[5rem] border border-coffee-50 shadow-premium-lg relative overflow-hidden group">
            <div className="absolute top-0 right-0 p-16 opacity-[0.03] transition-opacity duration-1000 group-hover:opacity-[0.08] pointer-events-none">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-16 gap-8 relative z-10">
              <div className="space-y-4">
                ...
                <h2 className="text-4xl font-display font-black text-coffee-950 italic uppercase tracking-tightest leading-none">Market <br/><span className="not-italic text-coffee-400">Diffusion.</span></h2>
              </div>
          ...
          <div className="bg-coffee-950 text-white p-12 md:p-16 rounded-[5rem] border border-white/5 shadow-premium-xl relative overflow-hidden group">
            ...
            <div className="flex items-center justify-between mb-16 relative z-10">
              <div className="space-y-4">
                ...
                <h2 className="text-4xl font-display font-black text-white italic uppercase tracking-tightest leading-none">Extraction <br/><span className="not-italic text-coffee-500">Logging.</span></h2>
              </div>
            ...
            <div className="space-y-12 relative z-10">
              {[1, 2, 3, 4, 5].map((_, i) => (
                ...
                >
                  <div className="flex items-center gap-6">
                    <div className="w-14 h-14 bg-white/5 rounded-2xl flex items-center justify-center group-hover/row:bg-gold-500 group-hover/row:text-white transition-all duration-500 shadow-xl border border-white/10">
                      <ShoppingBag size={24} strokeWidth={1} />
                    </div>
                    <div>
                      <p className="text-lg font-display font-black text-white italic uppercase leading-none tracking-tight">LOG_#{842 - i}</p>
                      <p className="text-[10px] font-black text-coffee-500 uppercase tracking-[0.4em] italic mt-2">TIMESTAMP: {i + 1}M_AGO</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-xl font-display font-black text-gold-500 italic tracking-tighter leading-none">{formatPrice(Math.random() * 2000000 + 400000).split('LBP')[1]}K</p>
                    <p className="text-[10px] font-black text-emerald-500 uppercase tracking-[0.4em] italic mt-2">NOMINAL_AUTH</p>
                  </div>
                </motion.div>
              ))}
              <div className="pt-8">
                <Link to="/admin/orders" className="btn-premium w-full py-6 italic text-xs uppercase ring-1 ring-white/20 shadow-none hover:shadow-gold-500/20 group/audit">
