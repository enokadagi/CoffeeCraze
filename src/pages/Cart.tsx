...
export default function Cart() {
  ...
  if (step === 3) {
    return (
      <div className="pt-60 pb-40 px-6 text-center max-w-3xl mx-auto space-y-16 flex flex-col items-center justify-center min-h-screen relative overflow-hidden">
        <div className="mesh-gradient absolute inset-0 opacity-20 pointer-events-none" />
        <motion.div 
          initial={{ scale: 0.5, opacity: 0, rotate: -20 }}
          animate={{ scale: 1, opacity: 1, rotate: 0 }}
          transition={{ duration: 1.2, ease: [0.22, 1, 0.36, 1] }}
          className="w-48 h-48 bg-white/40 backdrop-blur-3xl text-caramel rounded-[4rem] flex items-center justify-center shadow-premium-xl ring-1 ring-white/60 relative z-10"
        >
          <Truck size={64} strokeWidth={1} />
        </motion.div>
        <div className="space-y-8 relative z-10">
          <h1 className="text-7xl md:text-8xl font-display font-black text-espresso italic leading-none tracking-tightest">Ritual <br/><span className="not-italic text-caramel">Manifested.</span></h1>
          <p className="text-coffee-400 text-2xl font-serif italic max-w-md mx-auto leading-relaxed">"The distribution protocol has been initiated. Your sensory harvest is now under elite transit."</p>
        </div>
        <div className="pt-8 relative z-10">
          <Link to="/shop" className="btn-premium px-12 py-6 italic group">
      ...
      <div className="page-container relative z-10">
        <header className="mb-32 space-y-8">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8 md:gap-12 border-b border-espresso/5 pb-10 md:pb-20">
            <h1 className="text-5xl md:text-8xl font-display font-black text-espresso leading-none tracking-tightest italic uppercase">Sensory <br/><span className="not-italic text-coffee-400">Inventory.</span></h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-32">
          ...
          <div className="lg:col-span-8">
            <AnimatePresence mode="popLayout">
              {items.length > 0 ? (
                <div className="space-y-12">
                  {items.map((item) => (
                    <motion.div 
                      ...
                      className="flex flex-col md:flex-row gap-12 p-12 bg-white shadow-premium-xl border border-white rounded-[5rem] hover:shadow-premium-2xl transition-all duration-1000 group relative overflow-hidden"
                    >
                      ...
                      <div className="w-full md:w-56 aspect-[4/5] bg-cream rounded-[3.5rem] overflow-hidden flex-shrink-0 shadow-premium group-hover:scale-105 transition-transform duration-1000 border border-white">
                      ...
                      <div className="flex-grow flex flex-col justify-between py-6 relative z-10">
                        <div className="flex justify-between items-start gap-8">
                          <div className="space-y-3">
                            <h3 className="text-4xl font-display font-black text-espresso uppercase tracking-tightest leading-none italic">{item.name}</h3>
                          ...
                          <div className="text-right mt-4 md:mt-0">
                             <p className="text-3xl lg:text-4xl font-display font-black text-espresso italic tracking-tightest">{formatPrice(item.price)}</p>
                        ...
                        <div className="flex items-center justify-between pt-12">
                          <div className="flex items-center gap-8 bg-cream shadow-premium px-6 py-3 rounded-full border border-white group-hover:scale-105 transition-all duration-700">
                            ...
                            <span className="text-2xl font-black w-8 text-center font-display text-espresso italic">{item.quantity}</span>
                            <button 
                          ...
                          <button 
                            onClick={() => removeItem(item.id)} 
                            className="w-16 h-16 flex items-center justify-center text-coffee-200 hover:text-red-500 hover:bg-red-50 rounded-[1.5rem] shadow-premium transition-all duration-700 active:scale-75 border border-transparent hover:border-red-100"
                          >
                            <Trash2 size={24} />
                          </button>
                        </div>
                ...
                <div className="py-24 md:py-60 text-center flex flex-col items-center justify-center space-y-12 md:space-y-16 bg-white/40 backdrop-blur-xl rounded-[3rem] md:rounded-[6rem] border-2 border-dashed border-espresso/10 p-6 md:p-0">
                  <div className="w-24 h-24 md:w-40 md:h-40 bg-white rounded-full flex items-center justify-center shadow-premium-xl text-coffee-100 ring-1 ring-white">
                    <ShoppingBag size={40} className="md:w-[64px] md:h-[64px]" strokeWidth={0.5} />
                  </div>
                  <div className="space-y-6">
                    <h2 className="text-4xl md:text-6xl font-display font-black text-espresso italic tracking-tightest leading-none">Manifest <br/><span className="not-italic text-coffee-400">Empty.</span></h2>
                    <p className="text-xl text-coffee-400 font-serif italic max-w-sm mx-auto leading-relaxed">No active sensory extractions identified in your neural cache.</p>
                  </div>
                  <Link 
                    to="/shop" 
                    className="btn-premium px-10 py-5 italic group text-[10px]"
                  >
          ...
          <div className="lg:col-span-4 sticky top-40 h-fit">
            <div className="p-8 md:p-16 bg-espresso text-white rounded-[3rem] md:rounded-[5rem] shadow-premium-2xl space-y-8 md:space-y-12 relative overflow-hidden group">
              ...
              <div className="space-y-4 relative z-10">
                ...
                <h2 className="text-4xl font-display font-black tracking-tightest italic leading-none">Final <br/><span className="not-italic text-white font-black text-5xl tracking-normal">Induction.</span></h2>
              </div>
              ...
              <div className="space-y-8 text-[11px] font-black uppercase tracking-[0.5em] text-coffee-500 relative z-10 font-sans italic">
                <div className="flex justify-between items-center group/item hover:text-white transition-colors duration-500">
                  ...
                  <div className="text-right">
                    <span className="text-white font-display text-3xl tracking-tightest not-italic block">{formatPrice(subtotal)}</span>
                ...
                <div className="flex justify-between items-center group/item hover:text-white transition-colors duration-500">
                  ...
                  <div className="text-right">
                    <span className="text-caramel font-display text-3xl tracking-tightest not-italic block">{shipping === 0 ? 'FREE' : formatPrice(shipping)}</span>
                ...
                <div className="pt-10 border-t border-white/10 flex justify-between items-center">
                  ...
                  <div className="text-right">
                    <span className="text-5xl md:text-6xl font-display font-black text-caramel-gold tracking-tightest italic block">{formatPrice(grandTotal)}</span>
              ...
              <div className="space-y-8 relative z-10">
                 ...
                 <button 
                  ...
                  className="btn-premium w-full py-5 italic border border-white/20 group text-[11px] md:text-xs hover:bg-caramel hover:text-white transition-all duration-700 uppercase tracking-widest rounded-full"
                 >
            ...
            <div className="mt-8 md:mt-12 p-8 md:p-12 bg-white shadow-premium-xl border border-white rounded-[3rem] md:rounded-[4rem] group hover:border-caramel transition-all duration-1000">
